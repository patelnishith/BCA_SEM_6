...
$mob_id = $_GET['mob_id'];
$select = "SELECT * FROM tbl_mobiles WHERE id=$mob_id";
            ...
            <div class="row p-4 bg-white mt-5 mb-3 mx-5">
                <div class="pb-2 col-xl-10 col-lg-10 col-md-12 col-sm-12 col-12 mx-auto">
                    <div class="p-2 col-xl-10 col-lg-10 col-md-8 col-sm-12 col-12 mx-auto company-icon d-flex justify-content-between">
                        <img src="./assets/image/mobiles_icon/<?php echo $response['company_name'] ?>.svg" class="img-fluid p-0 col-xl-1 col-lg-1 col-md-2 col-sm-2 col-2">
                        <div class="share-icon p-xl-3 p-lg-3 p-md-2 p-sm-1 p-1 d-flex align-items-center justify-content-center">
                            <i class="fa fa-share-alt"></i>
                        </div>
                    </div>
                    <div class="images text-center mx-auto col-xl-5 col-lg-5 col-md-6 col-sm-8 col-8">
                        <img src="./admin/images/mobiles/<?php echo $response['product_img']; ?>" alt="<?php echo $response['product_name'] ?>" class="img-fluid">
                    </div>
                </div>
                <div class="col-xl-10 col-lg-10 col-md-12 col-sm-12 col-12 mx-auto  p-0  border-top">
                    <div class="model-name  py-2  mt-2">
                        <label for="model_name" class="text-capitalize font-weight-bold">product name</label>
                        <h3 id="model_name"><?php echo $response['product_name'] ?></h3>
                    </div>
                    ...
                    <div class="product-info  py-2  mt-2 border-top d-flex flex-lg-row flex-md-row flex-column">
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-10 col-10 pr-xl-1 pr-lg-1 pr-md-1 p-0">
                            <label for="processor" class="text-capitalize font-weight-bold">display</label>
                            <p id="processor"><?php echo $response['display'] ?></p>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-10 col-10 pl-xl-3 pl-lg-3 pl-md-3 p-0 border-left-mode">
                            ...
                            <p id="memory"><?php echo $response['memory_and_storage'] ?></p>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-10 col-10 pl-xl-3 pl-lg-3 pl-md-3 p-0 border-left-mode">
                            <label for="graphics" class="text-capitalize font-weight-bold">battery</label>
                            <p id="graphics"><?php echo $response['battery'] ?></p>
                        </div>
                    </div>
                    <div class="product-info py-2  mt-2 border-top d-flex flex-lg-row flex-md-row flex-column">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-10 col-10 pr-xl-1 pr-lg-1 pr-md-1 p-0">
                            <label for="display" class="text-capitalize font-weight-bold">operating system</label>
                            <p id="display"><?php echo $response['os'] ?></p>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-10 col-10 pl-xl-3 pl-lg-3 pl-md-3 p-0 border-left-mode">
                            <label for="design_battery" class="text-capitalize font-weight-bold">camera</label>
                            <p id="design_battery"><?php echo $response['camera'] ?></p>
                        </div>
                    </div>
                    <div class="product-info py-2  mt-2 border-top d-flex flex-lg-row flex-md-row flex-column">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-10 col-10 pr-xl-1 pr-lg-1 pr-md-1 p-0">
                            <label for="operating_system" class="text-capitalize font-weight-bold">sim</label>
                            <p id="operating_system"><?php echo $response['sim'] ?></p>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-10 col-10 pl-xl-3 pl-lg-3 pl-md-3 p-0 border-left-mode">
                            <label for="ports_cd_drive" class="text-capitalize font-weight-bold">processor</label>
                            <p id="ports_cd_drive"><?php echo $response['processor'] ?></p>
                        </div>
                    </div>
                    <div class="product-info py-2  mt-2 border-top d-flex flex-lg-row flex-md-row flex-column">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-10 col-10 pr-xl-1 pr-lg-1 pr-md-1 p-0">
                        <label for="keyboard" class="text-capitalize font-weight-bold">weight</label>
                            <p id="keyboard"><?php echo $response['weight'] ?></p>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-10 col-10 pl-xl-3 pl-lg-3 pl-md-3 p-0 border-left-mode">
                            <label for="audio" class="text-capitalize font-weight-bold">inside the box</label>
                            <p id="audio"><?php echo $response['inside_the_box'] ?></p>
                        </div>
                    </div>
                    <div class="product-info  py-2  mt-2 border-top d-flex flex-lg-row flex-md-row flex-column">
                        <div class="col-xl-10 col-lg-10 col-md-10 col-sm-10 col-10 pr-xl-1 pr-lg-1 pr-md-1  p-0">
                            <label for="camera" class="text-capitalize font-weight-bold">warranty</label>
                            <p id="camera"><?php echo $response['warranty']; ?></p>
                        </div>
                    ...
                    <div class="product-info  py-2  mt-2 border-top d-flex justify-content-between">
                        ...
                        <a href="order_items.php?p_id=<?php echo $response['id'];?>&type=mobile" class="btn btn-primary text-capitalize  buy-now  mt-2"><i class="fas fa-shopping-cart pr-1"></i>buy now</a>
                        </div>

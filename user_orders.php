...
$select_mob = "SELECT tbl_orders.id, tbl_mobiles.product_img,tbl_mobiles.product_name,tbl_mobiles.price, tbl_orders.quantity FROM tbl_orders INNER JOIN tbl_mobiles ON tbl_orders.p_id=tbl_mobiles.id AND tbl_orders.user_id=$login_id AND tbl_orders.type='mobile'"; 
$check_mob = mysqli_query($connection, $select_mob);
$select_lap="SELECT tbl_orders.id,tbl_laptops.product_img,tbl_laptops.model_name,tbl_laptops.price,tbl_orders.quantity FROM tbl_orders INNER JOIN tbl_laptops ON tbl_laptops.id=tbl_orders.p_id AND tbl_orders.user_id=$login_id AND tbl_orders.type='laptop'";
                  ...
                  <div class="card d-flex flex-row border-0">
                    ...
                    <div class="card-body w-50">
                        ...
                        <div class="d-flex flex-row">
                            ...
                            <p class="mt-1 pl-1"><?php echo $result['quantity']?></p>
                        </div>
                    </div>
                    <div class="w-25 py-2 delete-btn  d-flex justify-content-center mt-3">
                        <a href="delete_laptop_user_orders.php?lap_orders_id=<?php echo $result['id']; ?>"><i class="fa fa-trash p-2 text-danger" title="delete"></i></a>
                    </div>
                </div>
                <?php
                } ?>
                ...
                ?>
                    <div class="card d-flex flex-row border-0">
                        ...
                        <div class="card-body w-50">
                            ...
                            <div class="d-flex flex-row">
                                <label for="">quantity:-</label>
                                <p class="mt-1 pl-1"><?php echo $response['quantity']; ?></p>
                            </div>
                        </div>
                        <div class="w-25 py-2 delete-btn  d-flex justify-content-center mt-3">
                            <a href="delete_mobile_user_orders.php?mob_orders_id=<?php echo $response['id']; ?>"><i class="fa fa-trash p-2 text-danger" title="delete"></i></a>
                        </div>
                    </div>
                <?php
                }
